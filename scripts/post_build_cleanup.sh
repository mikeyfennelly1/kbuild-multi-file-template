...
function remove_unnecessary_files() {
    local list_of_unnecesssary_files=("start.mod.o" "stop.mod.o" ".Module.symvers.cmd" "modules.order.cmd" ".start.ko.cmd" "start.mod.cmd" "start.o.cmd" ".stop.mod.o.cmd" "modules.order" ".modules.order.cmd" "Module.symvers" "start.mod" "start.mod.c" ".start.mod.cmd" ".start.mod.o.cmd" ".start.o.cmd" ".stop.ko.cmd" "stop.mod" "stop.mod.c" ".stop.mod.cmd" ".stop.o.cmd")
